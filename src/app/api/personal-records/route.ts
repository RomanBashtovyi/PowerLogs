  ...
  try {
    ...
    if (
      ...
      return NextResponse.json(
        {
          error:
            'Positive 1RM value is required for weight-based records',
        },
        { status: 400 }
      )
    }
    ...
    if (
      ...
      return NextResponse.json(
        {
          error:
            'Positive max reps value is required for rep-based records',
        },
        { status: 400 }
      )
    }
    ...
    console.error(
      'Error creating/updating personal record:',
      error
    )
    return NextResponse.json(
      { error: 'Internal server error' },
