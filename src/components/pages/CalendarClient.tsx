  ...
  useEffect(() => {
    ;(async () => {
      ...
      const res = await fetch(
        `/api/workouts?limit=200&offset=0`
      )
    ...
    <div className="max-w-5xl mx-auto px-4 py-6 space-y-4">
      ...
      <div className="grid grid-cols-7 gap-2">
        ...
        {days.map((info, idx) => (
          <div
            key={idx}
            className="border rounded min-h-[72px] p-2 bg-background"
          >
            {info && (
        ...
        <div className="fixed inset-0 bg-black/40 flex items-center justify-center z-50">
          <div className="bg-background border border-border rounded-lg w-full max-w-lg p-4">
            ...
            <div className="space-y-3 max-h-96 overflow-auto">
              ...
              {(!workoutsByDate[modalDate] ||
                workoutsByDate[modalDate].length === 0) && (
