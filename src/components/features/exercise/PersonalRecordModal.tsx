...
export default function PersonalRecordModal({
  ...
  >(
    currentRecord?.recordType ||
      (isBodyweightExercise ? 'reps' : 'weight')
  )
      ...
      <div className="bg-background border border-border rounded-lg shadow-lg max-w-md w-full mx-4 overflow-hidden animate-in fade-in zoom-in-95 duration-300">
        ...
        <div className="p-6 pb-4">
          ...
          <p className="text-muted-foreground leading-relaxed mb-4">
            {recordType === 'reps'
              ? t('setPRRepsDescription') ||
                'Set your maximum reps for this exercise'
              : t('setPRDescription') ||
                'Set your one-rep max for percentage-based programming'}
          </p>
          ...
          >
            ...
            {recordType === 'weight' && (
              <div className="space-y-3">
                <label className="block text-sm font-medium text-foreground">
                  {t('howToSetPR') ||
                    'How would you like to set your 1RM?'}
                </label>
                <div className="space-y-2">
                  <label className="flex items-center gap-2 cursor-pointer">
                    <input
